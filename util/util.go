...
// // 文件上传
// func WriteFile(base string, file *multipart.FileHeader) (*handle.Reply, coding.Code) {
// 	if file == nil {
...
// 	return &handle.Reply{URL: config.BaseURL + filename, ShortURL: base}, coding.New(coding.StatusOK, 500, err)
// }
